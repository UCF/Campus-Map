...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmergencyAED'
        db.create_table(u'campus_emergencyaed', (
            (u'mapobj_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['campus.MapObj'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'campus', ['EmergencyAED'])

    def backwards(self, orm):
        # Deleting model 'EmergencyAED'
        db.delete_table(u'campus_emergencyaed')
