...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShuttleStop.route'
        db.add_column(u'campus_shuttlestop', 'route',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='shuttle_stops', to=orm['campus.ShuttleRoute']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShuttleStop.route'
        db.delete_column(u'campus_shuttlestop', 'route_id')
